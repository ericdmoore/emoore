...
/* globals test describe test expect  beforeAll  */
...
// import { batch } from '../../server/utils/ranges/batch'
...
//       // const r =
//       await saveExpandEvent(short, long, d, clicksPer).updateIndexes()
//       // console.log(r)
//     }
...
// describe.skip('Test Harness to Deal with Click Events', () => {
...
//     await seriesP(
//       links.map((l, i) => spreadClicksOverTime(l.short, l.long)(
//         (i + 1) * 24,
//         (i + 1),
//         { start: nowish, stop: daysAgo1 }
//       ))
//     ) // hrsAgo
...
//   test('Link History for this link0', async () => {
//     const { short } = links[0]
...
//     expect(sumUpClicks(r.hoursAgo)).toEqual(14) // was 24,11
