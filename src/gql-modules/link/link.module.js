...
exports.linkModule = graphql_modules_1.createModule({
    id: 'linkModule',
    dirname: __dirname,
    typeDefs: graphql_modules_1.gql(loadSchema_1.loadSchemaFromFsSync(fs, 'link.graphql'))
});
exports.default = exports.linkModule;
